			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header border-0 rounded-0">
						<button type="button" class="btn-close border-0 rounded-0" data-bs-dismiss="modal"
			...
			<div class="row mt-3">
				...
				<?php if ( ! empty( $job['wp_url'] ) ) { ?>
					<a class="btn btn-outline-light btn-lg fs-6 px-5 rounded-0"
					   href="<?php echo $job['wp_url']; ?>" role="button" target="_blank">Get it on WordPres
				...
				<?php if ( ! empty( $job['down_url'] ) ) { ?>
					<a class="btn btn-outline-light btn-lg fs-6 px-5 rounded-0"
					   href="<?php echo $job['down_url']; ?>" role="button" target="_blank">Download .zip
						<svg width="20" height="20" aria-hidden="true" focusable="false" role="img"
						     xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="ml-2 pb-1">
				...
				<?php if ( ! empty( $job['github_url'] ) ) { ?>
					<a href="<?php echo $job['github_url']; ?>" role="button"
					   class="btn btn-outline-light btn-lg fs-6 px-5 rounded-0" target="_blank">
						View on GitHub
						<svg width="20" height="20" aria-hidden="true" focusable="false" role="img"
