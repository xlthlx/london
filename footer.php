    ...
    <div class="footer-copyright py-2 text-center">
        ...
        <p class="mt-3">This website proudly uses the wonderful
            <a target="_blank" href="https://www.jetbrains.com/lp/mono/"
               title="JetBrains Mono: A free and open source typeface for developers">JetBrains
                Mono</a> typeface.
            <span style="display:none" id="top-arrow"
                  class="top-arrow text-right"><a title="Back to top"
                                                  href="#top">
                <svg width="25" height="25" data-icon="arrow-up" role="img"
