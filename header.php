				...
				<ul class="navbar-nav me-auto mb-2 mb-md-0">
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="dropdown-link">
							...
							<li><a href="#wordpress-plugins" class="dropdown-item">WordPress Plugins</a></li>
							<li><a href="#contacts" class="dropdown-item">Contacts</a></li>
						</ul>
					</li>
				</ul>
				<div class="d-flex">
					<a class="text-white me-3" title="GitHub" href="https://github.com/xlthlx" rel="noreferrer noopener"
					   target="_blank">
						<svg width="25" height="25" data-icon="github" role="img" xmlns="http://www.w3.org/2000/svg"
							 viewBox="0 0 496 512">
					...
					<a class="text-white" title="LinkedIn" href="https://www.linkedin.com/in/serenapiccioni/"
					   rel="noreferrer noopener" target="_blank">
						<svg width="25" height="25" data-icon="linkedin-in" role="img"
