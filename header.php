			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav me-auto mb-2 mb-md-0">
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="dropdown-link" data-bs-toggle="dropdown" aria-expanded="false">Curriculum vitae</a>
				...
				<div class="d-flex">
					<a class="text-white me-3" title="GitHub" href="https://github.com/xlthlx" rel="noreferrer noopener" target="_blank">
						<svg width="25" height="25" data-icon="github" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
					...
					<a class="text-white" title="LinkedIn" href="https://www.linkedin.com/in/serenapiccioni/" rel="noreferrer noopener" target="_blank">
						<svg width="25" height="25" data-icon="linkedin-in" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
							<path fill="currentColor"
	...
	<div id="content" class="container">
		...
		<section class="d-flex my-4">
			<div class="ms-auto text-end p-3">
				<h1><a class="h1" href=""><?php echo get_bloginfo( 'name' ); ?></a></h1>
