 ...
 * @return string
 */
function ln_change_version_from_style_js( $src ) {
...
if ( ! is_admin() ) {
	add_filter( 'style_loader_src', 'ln_change_version_from_style_js', 9999, 1 );
	add_filter( 'script_loader_src', 'ln_change_version_from_style_js', 9999, 1 );
}
