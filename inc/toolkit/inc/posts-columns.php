 ...
 * @return array
 */
function ln_posts_columns( $columns ) {
 ...
 */
function ln_posts_custom_columns( $column_name, $id ) {
...
if ( is_admin() ) {
	add_filter( 'manage_posts_columns', 'ln_posts_columns', 999999 );
	add_action( 'manage_posts_custom_column', 'ln_posts_custom_columns', 999999, 2 );
}
